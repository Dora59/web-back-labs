...
if app.config['DB_TYPE'] == 'postgres':
    db_name = 'dora_pyatina_orm'
    db_user = 'dora_pyatina_orm'
    db_password = '777'
    host_ip = '127.0.0.1'
    host_port = 5432
    ...
    db_path = path.join(dir_path, "dora_pyatina_orm.db")
    ...
    <body>
        ...
        <div>
            <ul>
                ...
                <li><a href="/lab7/">7 лабораторная работа</a></li>
                <li><a href="/lab8/">8 лабораторная работа</a></li>
                <li><a href="/lab9/">9 лабораторная работа</a></li>
            </ul>
        </div>
